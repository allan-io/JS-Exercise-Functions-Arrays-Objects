 ...
 * 
*/
const sayGoodbye = name => `Goodbye, ${name}. Have a great day.`
...
*/
const getCarInfoByIndex = (array, index) => {
...
*/
const getOlderCars = (array, maxYear) => {
  const olderCars = []
